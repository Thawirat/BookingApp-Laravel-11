    ...
    <table align="center" width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td style="padding:30px; color:#333;">
                <h3 style="margin-top:0;">สวัสดี <?php echo new \Illuminate\Support\EncodedHtmlString($user->name); ?></h3>
                <p style="font-size:15px; line-height:1.6;">
                    คุณได้ร้องขอการรีเซ็ตรหัสผ่านสำหรับบัญชี
                    <strong><?php echo new \Illuminate\Support\EncodedHtmlString($user->email); ?></strong>
                </p>
...
<?php /**PATH /var/www/html/resources/views/otp-verify.blade.php ENDPATH**/ ?>