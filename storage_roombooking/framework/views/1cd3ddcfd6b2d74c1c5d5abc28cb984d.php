<div
    ...
    <a href="<?php echo e(route('booking.index')); ?>"
        class="inline-block mt-6 bg-inherit text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 border border-white/20"
        style="text-decoration: none;">
        <i class="fas fa-calendar-plus me-2" style="text-decoration: none;"></i>
        จองห้องเลย
    </a>
</div>
