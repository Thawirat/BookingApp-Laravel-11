            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body text-center px-4 py-4">
                        ...
                        <p class="text-muted">บัญชีผู้ใช้งาน</p>
                ...
                <div class="card mt-4">
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('user.updateAll') }}" enctype="multipart/form-data" id="profileForm">
                            ...
                            <div class="mb-3">
                                <label class="form-label ms-1"><i class="fas fa-map-marker-alt me-2 text-primary"></i>ที่อยู่</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label ms-1"><i class="fas fa-check-circle me-2 text-primary"></i>ยืนยันรหัสผ่านใหม่</label>
