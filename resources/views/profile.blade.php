            ...
            <div class="card shadow-sm mb-4 border-0">
                ...
                <div class="card-body text-center">
                    <img src="{{ Auth::user()->avatar_url ?? asset('images/profile-avatar2.png') }}" alt="User Avatar"
                        class="rounded-circle border border-4 border-primary mb-3" style="width: 130px; height: 130px;">
                    ...
                    <form method="POST" action="{{ route('user.updateAll') }}" enctype="multipart/form-data" id="profileForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="user_type" class="form-select" disabled>
                                    <option value="internal" {{ Auth::user()->user_type == 'internal' ? 'selected' : '' }}>บุคลากรภายใน</option>
                                    <option value="external" {{ Auth::user()->user_type == 'external' ? 'selected' : '' }}>บุคคลภายนอก</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">ตำแหน่ง</label>
                                <input type="text" name="position" value="{{ Auth::user()->position }}" class="form-control" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="department" value="{{ Auth::user()->department }}" class="form-control" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">เบอร์โทร</label>
                                <input type="text" name="phone_number" value="{{ Auth::user()->phone_number }}" class="form-control" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <!-- Password -->
                        <h5 class="text-primary"><i class="fas fa-key me-2"></i>เปลี่ยนรหัสผ่าน (ไม่กรอกหากไม่ต้องการเปลี่ยน)</h5>
                        <div class="row">
