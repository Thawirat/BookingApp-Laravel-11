    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form class="space-y-6" action="{{ route('register') }}" method="POST">
            ...
            <div>
                ...
                <input class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    id="email" name="email" type="email" required placeholder="เช่น user@snru.ac.th"
                    pattern="^[a-zA-Z0-9._%+-]+@snru\.ac\.th$"
                    title="กรุณากรอกอีเมลที่ลงท้ายด้วย @snru.ac.th เท่านั้น" />
            </div>
            <div>
