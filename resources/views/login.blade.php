    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        @if ($errors->any())
            <div class="flex justify-center">
                <div
                    class="bg-red-100 border border-red-400 text-red-700 px-6 py-4 rounded relative max-w-md w-full text-center">
        ...
        <form class="space-y-6" action="{{ route('login.post') }}" method="POST">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" id="remember_me"
        ...
        <p class="mt-6 text-center text-gray-600">ยังไม่มีบัญชี? <a class="text-blue-500 hover:underline"
                href="{{ url('/register') }}">สมัครสมาชิก</a></p>
